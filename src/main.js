...
document.querySelector('#app').innerHTML = `
  ...
  <header class="nav">
    <a class="logo" href="#top" aria-label="Rolff Startseite"><img src="/assets/Logo.png" alt="Fritz & Tobias Rolff Bedachungen GmbH & Co. KG"></a>
  ...
  <footer><a class="logo footer-logo" href="#top"><img src="/assets/Logo.png" alt="Rolff Bedachungen"></a><p>Fritz u. Tobias Rolff Bedachungen GmbH & Co. KG<br>Neuer Weg 3 · 37688 Beverungen-Amelunxen</p><div><span>Unverbindliche Design-Demo</span><a class="ka-credit" href="https://katechnologies.de" target="_blank" rel="noopener">Konzept & Design · <strong>KA Technologies</strong> ${icon('arrow')}</a></div></footer>
